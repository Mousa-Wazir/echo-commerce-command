      ...
      <div className="space-y-6">
        ...
        {showCreateForm && <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              })} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900" placeholder="Enter email subject" required />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Audience</label>
                  <select value={formData.audience} onChange={e => setFormData({
                ...formData,
            ...
            })} rows={8} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900" placeholder="Write your email content here..." required />
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Schedule Date (Optional)</label>
                  <input type="date" value={formData.scheduleDate} onChange={e => setFormData({
                ...formData,
                ...
                <div>
                  ...
                  <input type="time" value={formData.scheduleTime} onChange={e => setFormData({
                ...formData,
                ...
                {campaigns.map(campaign => <tr key={campaign.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-2">
                        ...
                        {campaign.status === 'draft' && <button className="text-green-600 hover:text-green-900 p-1 rounded">
